...
class TrinoTableMetadataReaderTest {
    private Map<String, String> rawProperties;
    private TrinoTableMetadataReader reader;

    @BeforeEach
    void beforeEach() {
        this.rawProperties = new HashMap<>();
        final AdapterProperties properties = new AdapterProperties(this.rawProperties);
        this.reader = new TrinoTableMetadataReader(null, null, properties, null,
                BaseIdentifierConverter.createDefault());
    }

    @CsvSource({ //
            "foobar    , NONE                       , CONVERT_TO_UPPER      , true", //
            "foobar    , TRINO_UPPERCASE_TABLES, CONVERT_TO_UPPER      , true", //
            "FooBar    , TRINO_UPPERCASE_TABLES, PRESERVE_ORIGINAL_CASE, true", //
    ...
    void testIsUppercaseTableIncludedByMappingWithIgnoringUppercaseTables() {
        ignoreErrors("TRINO_UPPERCASE_TABLES");
    ...
    void testIsUppercaseTableIncludedByMappingWithConvertToUpperNotIgnoringUppercaseTablesThrowsException() {
        ...
        assertThat(exception.getMessage(), containsString("E-VSTR-6"));
    }
}
